...
api = Api(payment_flow_bp)

processor = PayloadProcessor()
data_processor=PROCESS_WHATSAPP_DATA()
class Payment_Flow_Webhook(Resource):
    def post(self):
        try:
            ...
            if body:
                ...
                if flow_token:
                    response_data=processor.process_payload_for_payment(payload=decrypted_data)
...
api.add_resource(Payment_Flow_Webhook, '/become_paid_member')